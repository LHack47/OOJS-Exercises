...
var kayla = new MyName("kayla", "isAwesome");

console.log(kayla.fname);
console.log(kayla.fullName());
...
var myPhoto = new Photo("dog.jpeg", "NYCDA");

var anotherPhoto = new Photo("cat.jpeg", "Taco Bell");
